package pe.edu.tecsup.firebaseapp.Activity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initGoogleSignIn(){
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("528798548305-89keerl0ov8edcnjtmgugv3vj2raaqvl.apps.googleusercontent.com")
                .requestEmail()
                .build();
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                try{
                    ...
                    if (AccessToken.getCurrentAccessToken() != null) {
                        ...
                        throw new Exception("Facebook Sign In failed!");
                    }
    ...
    private void onFacebookSuccess(final Profile profile){
        Log.d(TAG, "onCurrentProfileChanged: " + profile);
